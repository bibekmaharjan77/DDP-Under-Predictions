...
if __name__ == "__main__":
    ...
    save_compare_results_to_excel(res_cmp, n=1024, filename="whisker_1024_node.xlsx",
                                  graph_file="1024grid_diameter62test.edgelist")
    
    # print terminal summary for all error bands
    print_stretch_summary_from_excel("whisker_1024_node.xlsx", err_levels=None)
    ...
    plot_stretch_minmax_avg_from_excel("whisker_1024_node.xlsx", use_log_x=True)
