...
# Fully functional version using a generated 8x8 grid for consistent node structure
# Ensures spiral paths, cluster assignments, and stretch calculations are correct
...
def load_graph_from_directory(_):
    size = 8
