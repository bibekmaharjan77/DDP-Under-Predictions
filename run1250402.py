...
def assign_cluster_leaders(H, seed=42, prefer=None):
    """
...
def simulate_halving_compare_multibend(graph_file):
    ...
    leaders_base = assign_cluster_leaders(H_base, seed=42, prefer=None)
    ...
    for error in ERROR_VALUES:
        for k in k_values:
            ...
            for _ in range(NUM_TRIALS):
                ...
                leaders_pred = assign_cluster_leaders(H_base, seed=42, prefer=P)
