...
if __name__ == "__main__":
    ...
    save_compare_results_to_excel(res_cmp, n=1024, filename="random_leaders_mb_compare_1024.xlsx",
    ...
    # # or
    plot_mb_vs_ours_from_excel("random_leaders_mb_compare_1024.xlsx", use_avg=True, use_log_x=True, error_metric="ErrMax")
    # # or
